...
DEV_CORE="neovim"
SYS_HW="lm_sensors tailscale supergfxctl NetworkManager-tui bluetuith"
WM="xlibre-xserver xlibre-xf86-input-libinput xdg-desktop-portal xdg-desktop-portal-gtk dmenu slock arandr xset xsetroot maim xclip feh brightnessctl"
